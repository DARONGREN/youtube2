...
export default function Navbar() {
  ...
  return (
    <div className="flex justify-between items-center px-14 h-14 bg-[#212121] opacity-95 sticky top-0 z-50">
      <div className="flex gap-9 items-center text-2xl">
        <div>
          <GiHamburgerMenu />
        </div>
        <Link to="/">
          <div className="flex gap-1 items-center justify-center">
            <BsYoutube className="texl-3xl text-red-600" />
      ...
      <div className="flex gap-5 items-center text-xl">
        ...
        <img
          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTFZBWlzkKpnXwO7q2CJW0Igf-bBfBiagcgOQ&usqp=CAU"
          alt="logo"
